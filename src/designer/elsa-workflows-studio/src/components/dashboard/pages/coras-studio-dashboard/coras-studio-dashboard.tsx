...
@Component({
  tag: 'coras-studio-dashboard',
  shadow: false,
  assetsDirs: ['assets']
})
export class CorasStudioDashboard {
  ...
  render() {
    ...
    const logoPath = getAssetPath('./assets/CorasLogo.png');
            ...
            <div class="elsa-flex elsa-items-center elsa-justify-between elsa-h-16">
              <div class="elsa-flex elsa-items-center">
                <div class="elsa-flex-shrink-0">
                  <stencil-route-link url={`${basePath}/`}><img src={logoPath}
        ...
        <main>
          <stencil-router historyType={"hash"}>
            <stencil-route-switch scrollTopOffset={0}>
              <stencil-route url={`${basePath}/`} component="coras-studio-home" exact={true}/>
...
Tunnel.injectProps(CorasStudioDashboard, ['culture', 'basePath']);
