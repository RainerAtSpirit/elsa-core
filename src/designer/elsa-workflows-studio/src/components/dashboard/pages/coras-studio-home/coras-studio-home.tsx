...
@Component({
  tag: 'coras-studio-home',
  shadow: false,
  assetsDirs: ['assets']
})
export class CorasStudioHome {
  ...
  render() {
    ...
    return (
      <div class="elsa-home-wrapper elsa-relative elsa-bg-gray-300 elsa-overflow-hidden elsa-h-screen">
              ...
              <div class="elsa-px-4 sm:elsa-px-6 sm:elsa-text-center md:elsa-max-w-2xl md:elsa-mx-auto lg:elsa-col-span-6 lg:elsa-text-left lg:flex lg:elsa-items-center">
                <div class="elsa-home-caption-wrapper">
                  <h1 class="elsa-mt-4 elsa-text-4xl elsa-tracking-tight elsa-font-extrabold elsa-text-white sm:elsa-mt-5 sm:elsa-leading-none lg:elsa-mt-6 lg:elsa-text-5xl xl:elsa-text-6xl">
                    <span class="md:elsa-block"><IntlMessage label="Welcome" dangerous title={`<span class='elsa-text-teal-400 md:elsa-block'>Coras Workflows</span> <span>${serverVersion}</span>`}/></span>
                  </h1>
...
Tunnel.injectProps(CorasStudioHome, ['culture',  'serverVersion']);